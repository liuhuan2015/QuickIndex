package com.liuh.learn.quickindex.widget;
...
public class QuickIndexView extends View {
    ...
    public QuickIndexView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mPaint.setTextSize(TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 18, context.getResources().getDisplayMetrics()));
